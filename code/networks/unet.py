...
class Decoder(nn.Module):
    ...
    def forward(self, feature):
        ...
        return output,x
class DecoderVAT(nn.Module):
    def __init__(self, params):
        super(DecoderVAT, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.n_class = self.params['class_num']
    ...
    def forward(self, feature,t_model=None):
        if t_model is not None:
            feature = self.get_r_adv_t(feature, t_model[0], t_model[1])
        x0 = feature[0]
        x1 = feature[1]
        x2 = feature[2]
        x3 = feature[3]
